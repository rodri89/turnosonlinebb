...
class SecretariaController extends Controller
{
	...
	public function secretariaAsignarTurnos(Request $request){
        ...
        $primerControl = 0;
        $fechaLibreDisponible_aux1 = $this->turnoLibreMasCercanoApartirDia($request->get('medico_id'), $primerControl, 0, $aPartirDia); 
        ...
        if($request->get('medico_id') != 9){
            ...
            $fechaLibreDisponible_aux = $this->turnoLibreMasCercanoApartirDia($request->get('medico_id'), $primerControl, 0, $siguienteDia);
	...
	public function createJson($medico_id, $consultorio_id, $diaSeleccionado, $fechaSolicitada, $nombreAbreviado){
        if($medico_id == 1 || $medico_id == 8 || $medico_id == 13 || $medico_id == 12 || $medico_id == 14 || $medico_id == 15 || $medico_id == 18 || $medico_id == 19 || $medico_id == 24 || $medico_id == 26) {
        ...
        foreach($turnos as $turno){                                    
            ...
            if($encontre == 0){
        		...
        		$json['dni'] = "";
        		$json['nombre'] = "";
        		$json['tipo_turno'] = $turno->tipo_turno;
        		$json['tipo_turno_text'] = Util::getTipoTurno($turno->tipo_turno);                        			
        		$json['comentario'] = "";	        		
                $json['libre'] = 0;                   
                $data[] = $json;
            }            
    ...
    function checkTurnoLibre($medico_id, $fecha, $primerControl, $esVideollamada){        
        ...
        if($esVideollamada == 1){
        	...
        	if($medico->id == 1 || $medico->id == 6 || $medico->id == 8 || $medico->id == 13 || $medico->id == 12 || $medico->id == 14 || $medico->id == 15 || $medico->id == 18) {
	        	if($medico->id == 1)
