...
<div class="row">
  ...
  <h2 class="medicoTituloTextoCel">Bloquear Turno</h2><br>      
    <div class="col-md-2">
    <form> 
      @csrf                         
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">          
          ...
          <label for="text" class="col-sm-0" id="modal_texto_turno_eliminado" hidden>El turno ha sido cancelado.</label>           
      </div>
...
<script type="text/javascript">  
  ...
  function bloquearDia(fecha){
    ...
    if(especialidad == 2){
     ...
     $.ajax({
           type:'POST',
           dataType:'JSON',
           url:'/medico_bloquear_dia_agenda_semanal',
  ...
  function borrarTurno(dni, fecha, horario){
    ...
    //alert(medico+" "+consul +" "+fechaSeleccionada+" "+dni+" "+fecha+" "+horario);            
    var tipo_turno = 1;
    var especialidad = document.getElementById("especialidad_id").value;
    if(especialidad == 2){
      var tipoEstudio = document.getElementById("tipo_estudio_select").value;
    ...
    if(dni!=99999){
     ...
     $.ajax({
           type:'POST',
           dataType:'JSON',
           url:'/medico_borrar_turno_agenda_semanal',
    ...
    function actionBorrarTurno(){
      ...
      $.ajax({
           ...
           dataType:'JSON',
           url:'/medico_borrar_turno_agenda_semanal',
           data:{medico_id: medico, consultorio:consul, fechaInput:fechaSeleccionada, fechaTurno :fecha, horario:horario, _token: '{{csrf_token()}}'},
           success:function(data){                                                  
               generarListado(data);                  
               document.getElementById("modal_texto_dia_ok").hidden=true;
               document.getElementById("modal_texto_dia_fail").hidden=true;
