  ...
  function cargarTabla(data){
    ...
    for (i = 0; i < data.turnosPaciente.length; i++){
        ...
        if(data.moduloCajaComentario == 1){
          ...
          if(data.turnosPaciente[i].dni == 99999){
                     var paciente = "<tr><td class='editText'>"+contador+"</td><td>"+tipoTurno+"</td><td class='editText'>"+data.turnosPaciente[i].horario+"</td><td class='editText'>CANCELADO</td><td class='editText'></td><td class='editText'></td><td class='editText'></td><td></td></tr>";  
          } else {
            if(data.turnosPaciente[i].asistio == 0){ // todavia no se realizo accion
