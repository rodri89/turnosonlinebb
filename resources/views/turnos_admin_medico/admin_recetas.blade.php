  ...
  <div id="snackbar"><p id="snackbar_text"></p></div>
   ...
   $(document).ready( function () {
    $('#laravel_datatable_2').DataTable({
           ...
           processing: false,
           serverSide: false,
           ajax: "{{ url('receta-listado-medico') }}",
           columns: [
   ...
   function recetaListaEnviar(receta_id){
    ...
    function confirmarSolicitudReceta(){
      ...
      $.ajax({
         type:'POST',
         dataType:'JSON',
         url:'/medico_actualizar_estado_receta',
...
<script type="text/javascript">
 ...
 function cancelarSolicitudReceta2(){
  var receta_id = document.getElementById("modal_receta_id").value; 
