           ...
           <tbody id="pacientes-list1" name="pacientes-list1">        
            ...
            @if($turnos1 != null)
              @foreach($turnos1 as $tr)
                ...
                @if($tr["libre"]==1)              
                  @if($tr["tipo_turno"] == 1)              
                    <td><button class="rodri_button_agenda" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[0]}}','{{$tr['horario']}}')">
                    {{$tr["nombre"]}}</button></td>             
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[0]}}','{{$tr['horario']}}')">
                    {{$tr["nombre"]}}</button></td>             
                  @endif
                @else
                  @if($tr["tipo_turno"] == 1)              
            ...
            @foreach($turnos2 as $tr)
               <tr>            
                @if($tr["libre"] == 1)
                  ...
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[1]}}','{{$tr['horario']}}')">{{$tr["nombre"]}}</button></td>            
                  @endif
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[1]}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[1]}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
          ...
          @if($turnos3 != null)
            ...
            <tr>            
                @if($tr["libre"] == 1)
                  ...
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[2]}}','{{$tr['horario']}}')">{{$tr["nombre"]}}</button></td>          
                  @endif
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[2]}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[2]}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
          ...
          @if($turnos4 != null)
            ...
            <tr>            
                @if($tr["libre"]==1)
                  ...
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[3]}}','{{$tr['horario']}}')">{{$tr["nombre"]}}</button></td>        
                  @endif  
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[3]}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[3]}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
          ...
          @if($turnos5 != null)
            ...
            <tr>            
                @if($tr["libre"]==1)
                  ...
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="borrarTurno('{{$tr['dni']}}','{{$cincoDias[4]}}','{{$tr['horario']}}')">{{$tr["nombre"]}}</button></td> 
                  @endif
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[4]}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[4]}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
...
<script type="text/javascript">  
  ...
  function generarListado(data){
    ...
    for (i = 0; i < data.turnos1.length; i++) {
      var class1 = (data.turnos1[i].tipo_turno == 1)
          ? "rodri_button_agenda"
          : "rodri_button_agenda_tipo_turno";

      if(data.turnos1[i].libre == 1) {
        var head = '<tr><td><button class="' + class1 + '" onclick=borrarTurno("'+data.turnos1[i].dni+'","'+data.cincodias[0]+'","'+data.turnos1[i].horario+'")>'+data.turnos1[i].nombre+'</button></td></tr>';                
      } else{
        var head = '<tr><td><button class="' + class1 + '" onclick=reservarTurno("'+data.turnos1[i].horario+'","'+data.cincodias[0]+'")>'+data.turnos1[i].horario+'</button></td></tr>';                     
      } 
     ...
     for (i = 0; i < data.turnos2.length; i++) {
      var class1 = (data.turnos2[i].tipo_turno == 1)
          ? "rodri_button_agenda"
          : "rodri_button_agenda_tipo_turno";

      if(data.turnos2[i].libre == 1){
        var head = '<tr><td><button class="' + class1 + '" onclick=borrarTurno("'+data.turnos2[i].dni+'","'+data.cincodias[1]+'","'+data.turnos2[i].horario+'")>'+data.turnos2[i].nombre+'</button></td></tr>';                    
      } else{
        var head = '<tr><td><button class="' + class1 + '" onclick=reservarTurno("'+data.turnos2[i].horario+'","'+data.cincodias[1]+'")>'+data.turnos2[i].horario+'</button></td></tr>';                     
      } 
     ...
     for (i = 0; i < data.turnos3.length; i++) {
      var class1 = (data.turnos3[i].tipo_turno == 1)
          ? "rodri_button_agenda"
          : "rodri_button_agenda_tipo_turno";

      if(data.turnos3[i].libre == 1){
        var head = '<tr><td><button class="' + class1 + '" onclick=borrarTurno("'+data.turnos3[i].dni+'","'+data.cincodias[2]+'","'+data.turnos3[i].horario+'")>'+data.turnos3[i].nombre+'</button></td></tr>';
      } else{
        var head = '<tr><td><button class="' + class1 + '" onclick=reservarTurno("'+data.turnos3[i].horario+'","'+data.cincodias[2]+'")>'+data.turnos3[i].horario+'</button></td></tr>';                     
      } 
     ...
     for (i = 0; i < data.turnos4.length; i++) {
      var class1 = (data.turnos4[i].tipo_turno == 1)
          ? "rodri_button_agenda"
          : "rodri_button_agenda_tipo_turno";

      if(data.turnos4[i].libre == 1) {
        var head = '<tr><td><button class="' + class1 + '" onclick=borrarTurno("'+data.turnos4[i].dni+'","'+data.cincodias[3]+'","'+data.turnos4[i].horario+'")>'+data.turnos4[i].nombre+'</button></td></tr>';
      } else{
        var head = '<tr><td><button class="' + class1 + '" onclick=reservarTurno("'+data.turnos4[i].horario+'","'+data.cincodias[3]+'")>'+data.turnos4[i].horario+'</button></td></tr>';                     
      } 
     ...
     for (i = 0; i < data.turnos5.length; i++) {
      var class1 = (data.turnos5[i].tipo_turno == 1)
          ? "rodri_button_agenda"
          : "rodri_button_agenda_tipo_turno";
          
      if(data.turnos5[i].libre == 1){
        var head = '<tr><td><button class="' + class1 + '" onclick=borrarTurno("'+data.turnos5[i].dni+'","'+data.cincodias[4]+'","'+data.turnos5[i].horario+'")>'+data.turnos5[i].nombre+'</button></td></tr>';
      } else{
        var head = '<tr><td><button class="' + class1 + '" onclick=reservarTurno("'+data.turnos5[i].horario+'","'+data.cincodias[4]+'")>'+data.turnos5[i].horario+'</button></td></tr>';                     
      } 
