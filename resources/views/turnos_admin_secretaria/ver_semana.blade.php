...
<style type="text/css">
  .rodri_button_agenda_tipo_turno {
    background: #d7d3cb;
    border: none;
    width: 120px;  
    height: 25px;
...
<div class="row">
    ...
    <div class="col-md-5">
      <div class="col-md-5">
        ...
        <div class="col-md-8">
          ...
          <!--<label for="text" class="col-sm-0 control-label">Fecha libre mas cercana: {{$fechaLibreDisponible}}</label>           -->
        </div>
      </form>                                                                                   
    </div>    
</div>
  ...
  <br>
 <!-- @if($medico->id == 14)  Id Patricia Sosa 
  <h4 class="letrasrojo">Turnos Virtuales</h4>
  @endif
  @if($medico->id == 12) Id Lucas Sosa
  <h4 class="letrasrojo">JUEVES Turnos Virtuales</h4>
  @endif -->
    <div class="row">
      <br>
      ...
      <div class="col-md-2">
        ...
        <table class="table table-condensed" id="tabla_pacientes1" name="tabla_pacientes1">          
         <thead id="pacientes-list-head1" name="pacientes-list-head1">
            <tr>                    
                <th id="head1" scope="col"><small id="dia_semana_1_letras"></small><label id="dia_semana_1">{{$cincoDias[0]}}</label></th>
            </tr>
          </thead>         
           <tbody id="pacientes-list1" name="pacientes-list1">        
            ...
            @if($turnos1 != null)
              @foreach($turnos1 as $tr)
                ...
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[0]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[0]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @endif            
                @endif
              </tr>
              @endforeach
    ...
    <table class="table table-condensed" id="tabla_pacientes2" name="tabla_pacientes2">
     <thead id="pacientes-list-head2" name="pacientes-list-head2">
          <tr>                                  
              <th id="head2" scope="col"><small id="dia_semana_2_letras"></small><label id="dia_semana_2">{{$cincoDias[1]}}</label></th>              
          </tr>
        </thead>
          ...
          @if($turnos2 != null)
            @foreach($turnos2 as $tr)
               <tr>            
                ...
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[1]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[1]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
    ...
    <table class="table table-condensed" id="tabla_pacientes3" name="tabla_pacientes3">
     <thead id="pacientes-list-head3" name="pacientes-list-head3">
          <tr>                                  
              <th id="head2" scope="col"><small id="dia_semana_3_letras"></small><label id="dia_semana_3">{{$cincoDias[2]}}</label></th>              
          </tr>
        </thead>
         ...
         <tbody id="pacientes-list3" name="pacientes-list3">        
          ...
          @if($turnos3 != null)
            ...
            <tr>            
                ...
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[2]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[2]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
  ...
  <div class="col-md-2">
    <table class="table table-condensed" id="tabla_pacientes4" name="tabla_pacientes4">
     <thead id="pacientes-list-head4" name="pacientes-list-head4">
          <tr>                                  
              <th id="head2" scope="col"><small id="dia_semana_4_letras"></small><label id="dia_semana_4">{{$cincoDias[3]}}</label></th>              
          </tr>
        </thead>
         ...
         <tbody id="pacientes-list4" name="pacientes-list4">        
          ...
          @if($turnos4 != null)
            ...
            <tr>            
                ...
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[3]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>  
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[3]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>     
                  @endif
                @endif
              </tr>
            @endforeach
  ...
  <div class="col-md-2">
    <table class="table table-condensed" id="tabla_pacientes5" name="tabla_pacientes5">
     <thead id="pacientes-list-head5" name="pacientes-list-head5">
          <tr>                                  
              <th id="head2" scope="col"><small id="dia_semana_5_letras"></small><label id="dia_semana_5">{{$cincoDias[4]}}</label></th>              
          </tr>
        </thead>
         ...
         <tbody id="pacientes-list5" name="pacientes-list5">        
          ...
          @if($turnos5 != null)
            ...
            <tr>            
                ...
                @else
                  @if($tr["tipo_turno"] == 1)
                    <td><button class="rodri_button_agenda" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[4]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>    
                  @else
                    <td><button class="rodri_button_agenda_tipo_turno" onclick="reservarTurno('{{$tr['horario']}}','{{$cincoDias[4]}}','{{$tr['tipo_turno']}}','{{$tr['tipo_turno_text']}}')">{{$tr["horario"]}}</button></td>
                  @endif
                @endif
              </tr>
            @endforeach
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        @csrf
          ...
          <label id="label_tipo_turno" for="text" class="col-sm-0 control-label">Tipo Turno</label>      
          <input type="text" class="form-control" id="modal_tipo_turno" placeholder="Tipo Turno" />      
          <input type="hidden" class="form-control" id="modal_tipo_turno_id" />          
          ...
          <label id="label_telefono" for="text" class="col-sm-0 control-label editText">Telefono</label>      
          ...
          <label id="label_obra_social" for="text" class="col-sm-0 control-label editText">Obra Social</label>      
          ...
          <label id="label_numero_afiliado" for="text" class="col-sm-0 control-label editText">N° Afiliado</label>      
          <input type="text" class="form-control editText" id="modal_numero_afiliado" name="numero_afiliado" placeholder="N° Afiliado"  />
          
          <label id="label_plan" for="text" class="col-sm-0 control-label editText">Plan</label>      
          ...
          @if($medico->id == 13)
            ...
            <select class="form-control mercadopago_collapse_250px" id="tipo_turno_select" name="tipo_turno_select">            
                    ...
                    <option value="23">Ecografia</option>    
                    <option value="25">Consulta + Ecografia</option>    
            </select>
          @endif          
          ...
          <br>
          <div class="form-check">
            <input type="checkbox" class="form-check-input" id="primerControlCheck" name="primerControlCheck">
      ...
      <div class="modal-footer">
        ...
        <span class="pull-right">
          <button id="btn_registrar_turno" onclick="registrarTurno()" data-dismiss="modal" class="rodri_button_aceptar">Registrar</button>
...
<script type="text/javascript">  
  ...
  function reservarTurno(hora, fecha, tipo_turno_id, tipo_turno_text) {    
    $('#modal_tipo_turno_id').val(tipo_turno_id);
    $('#modal_tipo_turno').val(tipo_turno_text);
    ...
    var consul = document.getElementById("consultorio").value;     
     ...
     $.ajax({
           ...
           success:function(data){              
            ...
            // var letrasDia = diaSemana(data.cincodias[0])+" ";            
            $('#pacientes-list1').append("<tr><th><small id='dia_semana_1_letras'></small><label id='dia_semana_1'>"+data.cincodias[0]+"</label></th></tr>");                                              
            for (i = 0; i < data.turnos1.length; i++) {
              if(data.turnos1[i].libre == 1) {
                var head = "<tr><td>"+data.turnos1[i].nombre+"</td></tr>";                    
              } else {
                //rodri_button_agenda_tipo_turno
                if(data.turnos1[i].tipo_turno == 1) {                  
                  var head = '<tr><td><button class="rodri_button_agenda" onclick=reservarTurno("'+data.turnos1[i].horario+'","'+data.cincodias[0]+'","'+data.turnos1[i].tipo_turno+'","'+data.turnos1[i].tipo_turno_text+'")>'+data.turnos1[i].horario+'</button></td></tr>';                     
                } else {
                  var head = '<tr><td><button class="rodri_button_agenda_tipo_turno" onclick=\'reservarTurno('
                              + JSON.stringify(data.turnos1[i].horario) + ','
                              + JSON.stringify(data.cincodias[0]) + ','
                              + JSON.stringify(data.turnos1[i].tipo_turno) + ','
                              + JSON.stringify(data.turnos1[i].tipo_turno_text) + ')\'>' // <-- comilla simple cerrando onclick
                              + data.turnos1[i].horario + '</button></td></tr>';                    
                }
              } 
              $('#pacientes-list1').append(head);                                       
             }

             //letrasDia = diaSemana(data.cincodias[1])+" ";            
             $('#pacientes-list2').append("<tr><th><small id='dia_semana_2_letras'></small><label id='dia_semana_2'>"+data.cincodias[1]+"</th></tr>");
                                                      
             for (i = 0; i < data.turnos2.length; i++) {
              if(data.turnos2[i].libre == 1) {
                var head = "<tr><td>"+data.turnos2[i].nombre+"</td></tr>";                    
              } else{
                if(data.turnos2[i].tipo_turno == 1) {
                  var head = '<tr><td><button class="rodri_button_agenda" onclick=reservarTurno("'+data.turnos2[i].horario+'","'+data.cincodias[1]+'","'+data.turnos2[i].tipo_turno+'","'+data.turnos2[i].tipo_turno_text+'")>'+data.turnos2[i].horario+'</button></td></tr>';                     
                } else {
                  var head = '<tr><td><button class="rodri_button_agenda_tipo_turno" onclick=\'reservarTurno('
                              + JSON.stringify(data.turnos2[i].horario) + ','
                              + JSON.stringify(data.cincodias[1]) + ','
                              + JSON.stringify(data.turnos2[i].tipo_turno) + ','
                              + JSON.stringify(data.turnos2[i].tipo_turno_text) + ')\'>' // <-- comilla simple cerrando onclick
                              + data.turnos2[i].horario + '</button></td></tr>';                                          
                }
              } 
              $('#pacientes-list2').append(head);                                       
             }

             //letrasDia = diaSemana(data.cincodias[2])+" ";            
             $('#pacientes-list3').append("<tr><th><small id='dia_semana_3_letras'></small><label id='dia_semana_3'>"+data.cincodias[2]+"</th></tr>");
                                                      
             for (i = 0; i < data.turnos3.length; i++){
              if(data.turnos3[i].libre == 1){
                var head = "<tr><td>"+data.turnos3[i].nombre+"</td></tr>";                    
              } else{
                if(data.turnos3[i].tipo_turno == 1) {
                  var head = '<tr><td><button class="rodri_button_agenda" onclick=reservarTurno("'+data.turnos3[i].horario+'","'+data.cincodias[2]+'","'+data.turnos3[i].tipo_turno+'","'+data.turnos3[i].tipo_turno_text+'")>'+data.turnos3[i].horario+'</button></td></tr>';                     
                } else {
                  var head = '<tr><td><button class="rodri_button_agenda_tipo_turno" onclick=\'reservarTurno('
                              + JSON.stringify(data.turnos3[i].horario) + ','
                              + JSON.stringify(data.cincodias[2]) + ','
                              + JSON.stringify(data.turnos3[i].tipo_turno) + ','
                              + JSON.stringify(data.turnos3[i].tipo_turno_text) + ')\'>' // <-- comilla simple cerrando onclick
                              + data.turnos3[i].horario + '</button></td></tr>';
                }
              } 
              $('#pacientes-list3').append(head);                                       
             }

             //letrasDia = diaSemana(data.cincodias[3])+" ";            
             $('#pacientes-list4').append("<tr><th><small id='dia_semana_4_letras'></small><label id='dia_semana_4'>"+data.cincodias[3]+"</th></tr>");
                                                    
             for (i = 0; i < data.turnos4.length; i++){
              if(data.turnos4[i].libre == 1){
                var head = "<tr><td>"+data.turnos4[i].nombre+"</td></tr>";                    
              } else{
                if(data.turnos4[i].tipo_turno == 1) {
                  var head = '<tr><td><button class="rodri_button_agenda" onclick=reservarTurno("'+data.turnos4[i].horario+'","'+data.cincodias[3]+'","'+data.turnos4[i].tipo_turno+'","'+data.turnos4[i].tipo_turno_text+'")>'+data.turnos4[i].horario+'</button></td></tr>';                     
                } else {
                  var head = '<tr><td><button class="rodri_button_agenda_tipo_turno" onclick=\'reservarTurno('
                              + JSON.stringify(data.turnos4[i].horario) + ','
                              + JSON.stringify(data.cincodias[3]) + ','
                              + JSON.stringify(data.turnos4[i].tipo_turno) + ','
                              + JSON.stringify(data.turnos4[i].tipo_turno_text) + ')\'>' // <-- comilla simple cerrando onclick
                              + data.turnos4[i].horario + '</button></td></tr>';                     
                }
              } 
              $('#pacientes-list4').append(head);                                       
             }

             //letrasDia = diaSemana(data.cincodias[4])+" ";            
             $('#pacientes-list5').append("<tr><th><small id='dia_semana_5_letras'></small><label id='dia_semana_5'>"+data.cincodias[4]+"</th></tr>");
                                                      
             for (i = 0; i < data.turnos5.length; i++){
              if(data.turnos5[i].libre == 1){
                var head = "<tr><td>"+data.turnos5[i].nombre+"</td></tr>";                    
              } else{
                if(data.turnos5[i].tipo_turno == 1) {
                  var head = '<tr><td><button class="rodri_button_agenda" onclick=reservarTurno("'+data.turnos5[i].horario+'","'+data.cincodias[4]+'","'+data.turnos5[i].tipo_turno+'","'+data.turnos5[i].tipo_turno_text+'")>'+data.turnos5[i].horario+'</button></td></tr>';                     
                } else {
                  var head = '<tr><td><button class="rodri_button_agenda_tipo_turno" onclick=\'reservarTurno('
                              + JSON.stringify(data.turnos5[i].horario) + ','
                              + JSON.stringify(data.cincodias[4]) + ','
                              + JSON.stringify(data.turnos5[i].tipo_turno) + ','
                              + JSON.stringify(data.turnos5[i].tipo_turno_text) + ')\'>' // <-- comilla simple cerrando onclick
                              + data.turnos5[i].horario + '</button></td></tr>';
                }
              } 
  ...
  function registrarTurnoPaciente() {
    if(validarCamposRequired()){
      ...
      var tipo_turno = 1;
      if(medico == 13) {        
        tipo_turno = document.getElementById("tipo_turno_select").value;                  
      }
  ...
  function registrarTurno() {    
    ...
    fechaTurno = convertirFecha(fechaTurno);
    var fechaSeleccionada = document.getElementById("dia").value;   
    var tipo_turno = document.getElementById("modal_tipo_turno_id").value;   
    ...
    if(medico == 13) {        
     ...
     $.ajax({
           ...
           data:{medico_id: medico, consultorio:consul,horario:horario,paciente:paciente, fechaInput:fechaSeleccionada, fechaTurno :fechaTurno, tipo_turno:tipo_turno, primerControl:primerControlNum, _token: '{{csrf_token()}}'},
           success:function(data){              
            var contador = 0;
            ...
            if(data.turnoRegistrado == 1){
             ...
             $("#modalMensaje").modal(); 
               ...
               if(data.turnoRegistrado == 3){
                 ...
                 if(tipo_turno == 4)
                  document.getElementById("modal_texto_fail").innerHTML = "El paciente ya tiene un turno registrado para realizar otro estudio.";
                 else
                  document.getElementById("modal_texto_fail").innerHTML = "El paciente ya tiene un turno registrado para realizar un PEG.";
                 $("#modalMensaje").modal();
               } else {                         
                 document.getElementById("modal_texto_ok").hidden=true;
                 document.getElementById("modal_texto_fail").hidden=false;
                 document.getElementById("modal_texto_fail").innerHTML = "Lo siento, el turno se encuentra registrado, intente elegir otro horario.";
                 $("#modalMensaje").modal();                
              }
            }
            $('#reservarTurnoModal').modal('hide');
  ...
  function checkTurnosVirtuales(){    
      ...
      if((medico_id == id_lucas_sosa && dia1.localeCompare("Jue") == 0)){
      ...
      if((medico_id == id_lucas_sosa && dia2.localeCompare("Jue") == 0)){
      ...
      if((medico_id == id_lucas_sosa && dia3.localeCompare("Jue") == 0) ){
      ...
      if((medico_id == id_lucas_sosa && dia4.localeCompare("Jue") == 0) ){
      ...
      if((medico_id == id_lucas_sosa && dia5.localeCompare("Jue") == 0) ){
