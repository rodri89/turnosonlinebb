...
<div class="row">	
    ...
    <div class="col-md-3">
      ...
      @endif
			...
			<input class="form-control mercadopago_collapse_250px" type="text" id="dni_paciente" name="dni_paciente" value="" placeholder="Ingrese el DNI" onchange="validarPacienteExiste()" />
